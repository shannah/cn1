...
public final class Field extends AccessibleObject implements Member {
    ...
    private Field(Class<?> declaringClass, String name, Class<?> type, int modifiers, int offset,
            Object address, String signature, byte[] annotations) {
     ...
     * @since 1.5
     */
    native public boolean isEnumConstant();
     ...
     * @since 1.5
     */
    native public Type getGenericType();

    /**
     * Indicates whether or not the specified {@code object} is equal to this
     * field. To be equal, the specified object must be an instance of {@code
     * Field} with the same declaring class, type and name as this field.
     * 
     * @param object
     ...
     * <p>
     * If this field is static, the object argument is ignored. Otherwise, if
     * the object is null, a NullPointerException is thrown. If the object is
     * not an instance of the declaring class of the method, an
     ...
     * <p>
     * If this field is static, the object argument is ignored. Otherwise, if
     * the object is {@code null}, a NullPointerException is thrown. If the
     * object is not an instance of the declaring class of the method, an
     * IllegalArgumentException is thrown.
     * <p>
     * If this Field object is enforcing access control (see AccessibleObject)
     * and this field is not accessible from the current context, an
