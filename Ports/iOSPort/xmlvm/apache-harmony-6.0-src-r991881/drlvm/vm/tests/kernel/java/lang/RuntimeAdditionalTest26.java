...
public class RuntimeAdditionalTest26 extends TestCase {
    /**
     * get jvm process' streams, destroy, waitFor finish of the process then
     * read err stream, then exitValue
     */
    public void test_26() {
        System.out.println("==test_26===");
        if (RuntimeAdditionalTest0.os.equals("Unk")) {
            fail("WARNING (test_26): unknown operating system.");
        }
        try {
            ...
            fail("ERROR (test_26): unexpected exception.");
        }
    }
}