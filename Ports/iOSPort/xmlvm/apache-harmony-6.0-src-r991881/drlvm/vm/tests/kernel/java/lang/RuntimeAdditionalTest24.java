...
public class RuntimeAdditionalTest24 extends TestCase {
    /**
     * get jvm process' streams, "waitFor" finish of the process then read input
     * stream, then exitValue
     */
    public void test_24() {
        System.out.println("==test_24===");
        if (RuntimeAdditionalTest0.os.equals("Unk")) {
            fail("WARNING (test_24): unknown operating system.");
        }
        try {
            ...
            fail("ERROR (test_24): unexpected exception.");
        }
    }
}