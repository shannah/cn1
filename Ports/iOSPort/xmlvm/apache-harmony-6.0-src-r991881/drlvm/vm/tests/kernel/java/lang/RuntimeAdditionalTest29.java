...
public class RuntimeAdditionalTest29 extends TestCase {
    /**
     * create tree-process, get streams, read input stream, then exitValue
     */
    public void test_29() {
        System.out.println("==test_29===");
        String cmnd = null;
        ...
        try {
            ...
            fail("ERROR (test_29): unexpected exception.");
        }
