...
public class RuntimeAdditionalTest35 extends TestCase {
    /**
     * creat two cat-process, multi_byte-read from one multi_byte-write (using
     * flushing) to another and multi_byte-read there again wait finish of both
     * processes after the reading using "exitValue-destroy" loops
     */
    public void test_34() { // it can hang the test set run
        System.out.println("==test_34===");
        Process pi3 = null;
        Process pi4 = null;
        //String cmnd = null;
        String cmnd1 = null;
        ...
        try {
            ...
            fail("ERROR (test_34): unexpected exception.");
        }
        int i = 0;
        while (true) {
            try {
		...
		try{
			...
			fail("ERROR (test_34): unexpected exception: "+e.toString());
		}
    }
}