...
public class RuntimeAdditionalTest27 extends TestCase {
    /**
     * get jvm process' streams, waitFor finish of the process then read err
     * stream, then exitValue
     */
    public void test_27() {
        System.out.println("==test_27===");
        if (RuntimeAdditionalTest0.os.equals("Unk")) {
            fail("WARNING (test_27): unknown operating system.");
        }
        try {
            ...
            fail("ERROR (test_27): unexpected exception.");
        }
    }
}