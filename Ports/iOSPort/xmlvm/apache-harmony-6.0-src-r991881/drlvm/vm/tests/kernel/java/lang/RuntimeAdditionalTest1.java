...
public class RuntimeAdditionalTest1 extends TestCase {
    /**
     * destroy java process then chain of Process.waitFor, Process.exitValue,
     * Process.exitValue
     */
    public void test_2() {
        ...
        try {
            ...
            fail("ERROR (test_2): unexpected exception.");
        }
    }
}