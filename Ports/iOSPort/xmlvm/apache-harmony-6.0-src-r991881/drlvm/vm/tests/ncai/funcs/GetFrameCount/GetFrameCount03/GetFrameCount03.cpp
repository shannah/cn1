...
const char test_case_name[] = "GetFrameCount02";
...
Java_ncai_funcs_GetFrameCount02_stopsignal(JNIEnv *env, jclass cls)
{
    //warning fix
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetFrameCount03_TestFunction
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetFrameCount03_TestFunction1
  (JNIEnv *env, jobject obj)
{
