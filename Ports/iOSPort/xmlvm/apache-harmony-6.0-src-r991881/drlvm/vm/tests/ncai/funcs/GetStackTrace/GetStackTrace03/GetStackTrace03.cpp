...
const char test_case_name[] = "GetStackTrace03";
...
Java_ncai_funcs_GetStackTrace03_stopsignal(JNIEnv *env, jclass cls)
{
    //warning fix
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetStackTrace03_TestFunction
  (JNIEnv *env, jobject obj)
{
    ...
    jmethodID mid = env->GetMethodID(clazz, "TestFunction1", "()V");
    if (!mid)
    {
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetStackTrace03_TestFunction1
  (JNIEnv *env, jobject obj)
{
