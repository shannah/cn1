...
const char test_case_name[] = "GetStackTrace06n";
...
Java_ncai_funcs_GetStackTrace06n_resumeagent(JNIEnv *env, jclass cls)
{
    //warning fix
...
Java_ncai_funcs_GetStackTrace06n_stopsignal(JNIEnv *env, jclass cls)
{
    //warning fix
    int w_fix = sizeof(cls);
    w_fix += sizeof(env);
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetStackTrace06n_TestFunction
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetStackTrace06n_TestFunction1
  (JNIEnv *env, jobject obj)
{
