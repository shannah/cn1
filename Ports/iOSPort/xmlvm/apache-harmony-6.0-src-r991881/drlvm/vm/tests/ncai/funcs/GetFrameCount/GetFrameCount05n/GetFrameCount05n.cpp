...
const char test_case_name[] = "GetFrameCount05n";
...
Java_ncai_funcs_GetFrameCount05n_resumeagent(JNIEnv *env, jclass cls)
{
    //warning fix
...
Java_ncai_funcs_GetFrameCount05n_stopsignal(JNIEnv *env, jclass cls)
{
    //warning fix
    int w_fix = sizeof(cls);
    w_fix += sizeof(env);
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetFrameCount05n_TestFunction
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetFrameCount05n_TestFunction1
  (JNIEnv *env, jobject obj)
{
