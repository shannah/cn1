...
static const char test_case_name[] = "GetThreadHandle01";
...
Java_ncai_funcs_GetThreadHandle01_resumeagent(JNIEnv *env, jclass cls)
{
    //warning fix
...
Java_ncai_funcs_GetThreadHandle01_stopsignal(JNIEnv *env, jclass cls)
{
    //warning fix
    int w_fix = sizeof(cls);
    w_fix += sizeof(env);
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetThreadHandle01_TestFunction
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetThreadHandle01_TestFunction1
  (JNIEnv *env, jobject obj)
{
