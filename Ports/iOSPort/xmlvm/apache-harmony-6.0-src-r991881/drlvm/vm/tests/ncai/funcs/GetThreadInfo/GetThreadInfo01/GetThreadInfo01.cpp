...
const char test_case_name[] = "GetThreadInfo01";


extern "C" JNIEXPORT void JNICALL
Java_ncai_funcs_GetThreadInfo01_resumeagent(JNIEnv *env, jclass cls)
{
    //warning fix
...
Java_ncai_funcs_GetThreadInfo01_stopsignal(JNIEnv *env, jclass cls)
{
    //warning fix
    int w_fix = sizeof(cls);
    w_fix += sizeof(env);
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetThreadInfo01_TestFunction1
