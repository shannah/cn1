...
const char test_case_name[] = "GetStackTrace01";
...
Java_ncai_funcs_GetStackTrace01_stopsignal(JNIEnv *env, jclass cls)
{
    //warning fix
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetStackTrace01_TestFunction
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetStackTrace01_TestFunction1
  (JNIEnv *env, jobject obj)
{
