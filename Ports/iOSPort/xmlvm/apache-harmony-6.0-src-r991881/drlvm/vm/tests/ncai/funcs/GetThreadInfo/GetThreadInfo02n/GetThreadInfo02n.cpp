...
const char test_case_name[] = "GetThreadInfo02n";
/*
...
Java_ncai_funcs_GetThreadInfo02n_resumeagent(JNIEnv *env, jclass cls)
{
    //warning fix
...
Java_ncai_funcs_GetThreadInfo02n_stopsignal(JNIEnv *env, jclass cls)
{
    //warning fix
    int w_fix = sizeof(cls);
    w_fix += sizeof(env);
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetThreadInfo02n_TestFunction1
...
*/
    ...
    {
        ncaiThreadInfo info;
        ncai_err = ncai_env->GetThreadInfo(NULL, &info);
