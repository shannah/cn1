...
static const char test_case_name[] = "GetThreadHandle01n";
...
Java_ncai_funcs_GetThreadHandle01n_resumeagent(JNIEnv *env, jclass cls)
{
    //warning fix
...
Java_ncai_funcs_GetThreadHandle01n_stopsignal(JNIEnv *env, jclass cls)
{
    //warning fix
    int w_fix = sizeof(cls);
    w_fix += sizeof(env);
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetThreadHandle01n_TestFunction
...
extern "C" JNIEXPORT void JNICALL Java_ncai_funcs_GetThreadHandle01n_TestFunction1
  (JNIEnv *env, jobject obj)
{
                               ...
                               jmethodID catch_method, jlocation catch_location)
{
    ...
    ncai_err = ncai_env->GetThreadHandle(g_thread_jthread, NULL);
