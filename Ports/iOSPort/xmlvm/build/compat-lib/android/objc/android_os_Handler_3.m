...
@implementation android_os_Handler_3;

+ (void) initialize
{
    if (strcmp(class_getName(self), "android_os_Handler_3") == 0) {
    }
}
...
- (void) dealloc
{
    if (strcmp(object_getClassName(self), "android_os_Handler_3") == 0) {
        [self dealloc__];
    }
    [super dealloc];
}
...
- (void) __init_android_os_Handler_3___android_os_Handler :(android_os_Handler*)n1
{
    ...
    [_r0.o retain];
    [_r1.o retain];
    ((android_os_Handler_3*) _r0.o)->this_0_android_os_Handler = _r1.o;
...
- (void) timerEvent___org_xmlvm_iphone_NSTimer :(org_xmlvm_iphone_NSTimer*)n1
{
    ...
    [_r1.o retain];
    [_r2.o retain];
    _r0.o = ((android_os_Handler_3*) _r1.o)->this_0_android_os_Handler;
    [_r0.o retain];
    _rtmp.o =  _r0.o;
    _r0.o = ((android_os_Handler*) _r0.o)->toRun_java_lang_Runnable;
    [_r0.o retain];
    [_rtmp.o release];
    _rtmp.o = JAVA_NULL;
